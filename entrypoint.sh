...
echo -e "              \e[1;37mPowered By XM4ZE © 2022 - 2026\e[0m"
echo -e "               \e[36m[ SYSTEM INFO ]\e[0m \e[34m------------------------\e[0m"
echo -e "\e[90m╰─\e[0m \e[37mISP\e[0m        : \e[34m$ISP\e[0m"
echo -e "\e[90m╰─\e[0m \e[37mIPv4\e[0m       : \e[34m$IPV4 (Public IP)\e[0m"
...
echo -e "\e[34m-------------------------------------------------------\e[0m"
echo -e "\e[90m╰─\e[0m \e[37mNodeJS Ver\e[0m : \e[33m$NODE_VER\e[0m"
echo -e "\e[90m╰─\e[0m \e[37mPython Ver\e[0m : \e[33m$PYTHON_VER\e[0m"
echo -e "\e[90m╰─\e[0m \e[37mBun Ver\e[0m    : \e[33m$BUN_VER\e[0m"
echo -e "               \e[36m[ SERVER USAGE ]\e[0m \e[34m-----------------------\e[0m"
echo -e "\e[90m╰─\e[0m \e[37mCPU Cores\e[0m  : \e[37m$CPU_CORES Core(s) [$ARCH]\e[0m"
echo -e "\e[34m-------------------------------------------------------\e[0m"
echo -e " \e[36mINSTALLED :\e[0m \e[37mGOLANG, REDIS, MARIADB, PYTHON, CHROMIUM, YT-DLP\e[0m"
echo -e "\e[34m-------------------------------------------------------\e[0m"
